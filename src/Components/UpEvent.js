...
const UpEvent = () => {
  return (
    <div className="Events z-10" data-aos="fade-down">
      ...
      <h1 className="text-4xl text-center font-extrabold mb-9">
        Upcoming Events
      </h1>
      <h5 class="text-lg mt-0 mb-2 px-20 text-center">At GDSC, we organize a diverse range of events and activities to cater to the interests of our members. From workshops on cutting-edge technologies like machine learning, cloud computing, and mobile app development to hackathons that challenge your problem-solving abilities, we have something for everyone.</h5>
