const Contact = () => {
  return (
    <div className="Contact z-0">
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-300 sm:text-xl">Want to send feedback? Need details about events? Let us know.</p>
      <form action="https://submit-form.com/ORVh6bP2" className="space-y-8">
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 border-2 border-blue-800 sm:w-fit hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
      </form>
  </div>
    </div>
  );
