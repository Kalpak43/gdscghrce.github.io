...
import Speaker1 from "../../Images/speaker/AbhilashTelrandheBlur.png";
  ...
  return (
    <section className="speakers" id="speakers">
      {/* <div className="spkrs-l spkrs-l-pc w-full h-full flex flex-wrap gap-8 justify-center items-center">
        <Carousel showArrows={true} showStatus={false} showThumbs={false} autoPlay infiniteLoop interval={4000}>
          <div className="parent">
            <div className="ecard">
              ...
              <div className="content">
                ...
                <span className="title">Speaker 1</span>
                <span className="text">Founder | Designer | Illustrator</span>
              </div>
          ...
          <div className="parent">
            <div className="ecard">
              ...
              <div className="content">
                ...
                <span className="title">Speaker 2</span>
                <span className="text">Founder | Designer | Illustrator</span>
              </div>
              <div className="bottom">
                <div className="social-buttons-container">
      ...
      <div className="spkrs-l spkrs-l w-full h-full flex flex-wrap gap-8 justify-center items-center">
        <div className="parent">
          <div className="ecard">
            <div className="glass"></div>
            <div className="content">
              ...
              <span className="title">Revealing Soon...</span>
              <span className="text">Founder | Designer | Illustrator</span>
            </div>
            <div className="bottom">
              <div className="social-buttons-container">
